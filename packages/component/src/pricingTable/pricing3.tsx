...
const PriceItem3 = ({ styleName, headerStyle, itemStyle, footerStyle }: IProp) => {
    ...
    <div className={`${styleName}`}>
      <div className={`${headerStyle}`}>
        ...
        <p className="gx-letter-spacing-base gx-text-white gx-text-uppercase gx-mb-0">
          {getMessage('pricingTable_professional', enUS.pricingTable_business)}
        </p>
      </div>
      ...
      <div className={`${itemStyle}`}>
        <ul className="gx-package-items">
          ...
          <li>
            ...
            <span>{getMessage('pricingTable_awesomeGoogleFonts', enUS.pricingTable_business)}</span>
          </li>
          <li>
