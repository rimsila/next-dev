...
import Teams1 from '../../src/Team/team1';
...
export default () => {
                  ...
                  titleWrapper: {
                    children: [
                      ...
                      },
                      {
                        ...
                        className: 'teams1-content',
                        children:
                          'AntV is Ant Financial next-generation data visualization solution, dedicated to providing a set of simple, convenient, professional and reliable data visualization best practices. ',
                      },
                    ],
                  },
                },
        ...
        dataSource: {
          copyright: {
            ...
            children: [
              ...
              {
                name: 'group',
                children: 'Ant Financial Experience Technology Conference',
              ...
              {
                name: 'copyright',
                children: 'Copyright © Ant Financial Services Group',
  ...
  return <MapItem {...{ data, antSpan: 24, gut1: 50 }} />;
};
